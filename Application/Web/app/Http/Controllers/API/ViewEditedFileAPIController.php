...
class ViewEditedFileAPIController extends Controller
{
    ...
    private function resolveFile(Request $request): ?Edit
    {
        $fileId = $request->get('id', null);
        $userId = (string) $request->user()?->getKey();
        $file = is_string($fileId) ? Edit::query()->whereKey($fileId)->first() : null;
    ...
    private function getHeader(Edit $file): array
    {
        return [
